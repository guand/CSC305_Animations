...
//    float freq = M_PI*time_s*SPEED_FACTOR;
    ...
    head_M *= Eigen::Translation3f(0.0, 1.5 + wingFlap * 0.75, 0.0);
    ...
    wingR_M *= Eigen::Translation3f(1.3, 1.33 + wingFlap, 0.0);
    ...
    wingL_M *= Eigen::Translation3f(-1.3, 1.33 + wingFlap, 0.0);
